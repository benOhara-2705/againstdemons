// NAV MENU (MOBILE)
function scrollSideProjects() { // This function will allow the screen to scroll just above the 'Side Projects' div
    const sideProjectDiv = document.getElementById('side_projects_section');
    const scrollPosition = sideProjectDiv.offsetTop - 100;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollSoloReleases() { // This function will allow the screen to scroll just above the 'Members' div
    const membersDiv = document.getElementById('members_section');
    const scrollPosition = membersDiv.offsetTop - 100;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
let sectionButtonsRevealed = 0;

function revealSectionButtons() { // When the section reveal button is selected, reveal the container containing the section buttons
    if (sectionButtonsRevealed == 0) {
        document.getElementById('section_buttons_container').style.display = 'flex';
        document.getElementById('section_reveal_button').textContent = 'SKIP TO ▼'
        sectionButtonsRevealed = 1;
    } else {
        document.getElementById('section_buttons_container').style.display = 'none';
        document.getElementById('section_reveal_button').textContent = 'SKIP TO ►'
        sectionButtonsRevealed = 0;
    }
}
...
function scrollPH() { // This function will allow the screen to scroll just above the header box for the 'Pablo Honey' section
    const PHDiv = document.getElementById('ph_header');
    const scrollPosition = PHDiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollTB() { // This function will allow the screen to scroll just above the header box for the 'The Bends' section
    const TBDiv = document.getElementById('tb_header');
    const scrollPosition = TBDiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollOK() { // This function will allow the screen to scroll just above the header box for the 'OK Computer' section
    const OKDiv = document.getElementById('ok_header');
    const scrollPosition = OKDiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollKIDA() { // This function will allow the screen to scroll just above the header box for the 'Kid A' section
    const KIDADiv = document.getElementById('kida_header');
    const scrollPosition = KIDADiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollAM() { // This function will allow the screen to scroll just above the header box for the 'Amnesiac' section
    const AMDiv = document.getElementById('am_header');
    const scrollPosition = AMDiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollHTTT() { // This function will allow the screen to scroll just above the header box for the 'Hail to the Thief' section
    const HTTTDiv = document.getElementById('httt_header');
    const scrollPosition = HTTTDiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollIR() { // This function will allow the screen to scroll just above the header box for the 'In Rainbows' section
    const IRDiv = document.getElementById('ir_header');
    const scrollPosition = IRDiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollTKOL() { // This function will allow the screen to scroll just above the header box for the 'The King of Limbs' section
    const TKOLDiv = document.getElementById('tkol_header');
    const scrollPosition = TKOLDiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
...
function scrollAMSP() { // This function will allow the screen to scroll just above the header box for the 'A Moon Shaped Pool' section
    const AMSPDiv = document.getElementById('amsp_header');
    const scrollPosition = AMSPDiv.offsetTop - 95;
    window.scrollTo({
        top: scrollPosition,
        behavior: 'smooth',
    });
